		...
		<div id="welcomeLine" class="row">
			...
			<div class="span6">
				<div class="pull-right">
					<a href="{{url('/all-cart')}}"><span class="btn btn-mini btn-primary"><i class="icon-shopping-cart icon-white"></i> [<span class="cartCountItems">{{  countCartItems()}}</span>] Items in your cart </span> </a>
				</div>
			</div>
		</div>
		<!-- Navbar ================================================== -->
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @foreach ($category['sub_categories'] as $subCategory)
                                    <li><a href="{{url($category['url'])}}">>>>{{$subCategory['category_name']}}</a></li>
                                @endforeach
                                @endforeach
                            </ul>
                        </li>
